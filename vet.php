      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <h1 class="mb-0 bread">The Heart Behind Your Pet’s Health</h1>
          </div>
        </div>
      </div>
    </section>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 px-3 pb-4 text-center">
								...
								<div class="faded">
									<p>drh. Clarissa is a detail-oriented vet who specializes in pet nutrition, wellness programs, and preventive healthcare. With a warm personality, she educates pet owners on how to maintain their animals’ long-term health through proper diet and routine checkups.</p>
									<ul class="ftco-social text-center">
		                <li class="ftco-animate"><a href="#" class="d-flex align-items-center justify-content-center"><span class="fa fa-twitter"></span></a></li>
		                <li class="ftco-animate"><a href="#" class="d-flex align-items-center justify-content-center"><span class="fa fa-facebook"></span></a></li>
		                <li class="ftco-animate"><a href="#" class="d-flex align-items-center justify-content-center"><span class="fa fa-google"></span></a></li>
